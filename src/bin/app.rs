...
impl From<DatabaseConnfig> for PgConnectOptions {
    fn from(cfg: DatabaseConnfig) -> Self {
        Self::new()
            .host(&cfg.host)
            .port(cfg.port)
...
fn connect_database_with(cfg: DatabaseConnfig) -> PgPool {
...
async fn main() -> Result<()> {
    let database_cfg = DatabaseConnfig {
        host: "localhost".into(),
        port: 5432,
        username: "app".into(),
